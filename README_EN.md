...
A lightweight launcher for the DMM GAMES PC version of **THE IDOLM@STER Gakuen**, providing a faster way to start the game without using DMM for everyday launches.
...
**[Download the EXE from GitHub Releases](https://github.com/fullpie/GakumasDirectLauncher/releases/latest)**, or build it yourself by following the "Build from source" section below.
